<template>
  <header :class="[headerClass, textClass]" class="fixed z-50 flex h-20 w-full items-center gap-20">
    <router-link to="/" class="ml-64 mr-16">
      <img :src="logoSrc" alt="" width="142px" height="44px" />
    </router-link>
    <router-link to="/message" active-class="active-link" class="px-16 py-7">메시지</router-link>
    <router-link to="/credit" active-class="active-link" class="px-16 py-7">크레딧</router-link>
  </header>
</template>
